...
Notes are plain presenter narration. No bracketed markers, no `Key points:` / `Duration:` lines — see [executor-base.md §8](executor-base.md#8-speaker-notes-generation-framework).
...
- [ ] Notes contain no bracketed stage markers and no `Key points:` / `Duration:` meta-lines
