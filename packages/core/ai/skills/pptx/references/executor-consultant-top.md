...
Notes are plain presenter narration. No bracketed markers, no `Key points:` / `Duration:` / `Flex:` lines — see [executor-base.md §8](executor-base.md#8-speaker-notes-generation-framework).
...
- [ ] **Plain presenter prose**: No bracketed stage markers, no `Key points:` / `Duration:` / `Flex:` meta-lines
