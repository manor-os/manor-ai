...
Manor OS is a source-available, self-hosted AI workspace runtime for teams that
want agents, tools, documents, workflows, and integrations under their own
control.

The public repository is designed for operators who want to run Manor OS on
...
2. Review [Configuration](configuration.md) before exposing Manor OS to users.
...
- Source: [github.com/manor-os/manor-os](https://github.com/manor-os/manor-os)
